...
// ============================================================
// HOOK useScrollReveal mejorado (animación única y suave)
// ============================================================
...
const ModalProyecto = ({
  ...
  return (
    ...
    >
      <div
        className="relative bg-[#1D2024] border border-[#3A3F45] rounded-sm max-w-3xl w-full max-h-[90vh] overflow-y-auto shadow-2xl"
        onClick={(e) => e.stopPropagation()}
      >
        <CornerMarks active />
        <div className="sticky top-0 flex justify-between items-start p-6 bg-gradient-to-r from-[#FF5A1F] to-[#D94A14] text-white z-10">
          <h3
        ...
        <div className="p-6 space-y-6">
          <div className="relative h-64 rounded-sm overflow-hidden border border-[#3A3F45]">
            <img
              src={proyecto.imagen}
              alt={proyecto.titulo}
    ...
    <div className="min-h-screen bg-[#F7F7F4]" style={{ fontFamily: FONT_BODY }}>
      ...
      <section className="py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {/* Grid - ahora con animación solo al entrar, no al salir */}
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {proyectosFiltrados.map((proyecto, index) => {
              const CatIcon = categoriaEstilos[proyecto.categoria].icon;
              // Cada tarjeta tendrá su propia animación de entrada
