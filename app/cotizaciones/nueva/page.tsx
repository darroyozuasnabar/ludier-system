...
export default function NuevaCotizacionPage() {
  ...
  const seleccionarCliente = (nombre: string) => {
    setForm({ ...form, cliente: nombre });
    setSearchCliente(nombre);
  ...
  const guardarCotizacion = async () => {
    ...
    try {
      ...
      showToast("ok", "Cotización creada exitosamente");
      setTimeout(() => router.push("/cotizaciones"), 1000);
    } catch (error: any) {
      ...
      <header className="bg-white border-b border-zinc-100 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-sm font-bold text-zinc-900 leading-none">Nueva cotización</h1>
            ...
            <div className="md:col-span-2">
              ...
              <div className="relative">
                <input
                  ...
                  onFocus={() => {
                    if (searchCliente.length >= 2) setShowClientes(true);
                  }}
                ...
                {showClientes && clientesFiltrados.length > 0 && (
                  <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-zinc-200 rounded-xl shadow-lg z-20 max-h-48 overflow-y-auto">
              ...
              <p className="text-[10px] text-zinc-400 mt-1">
                Escribe el nombre del cliente para buscar en proyectos existentes
              </p>
            </div>
